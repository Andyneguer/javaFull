 ...
 * generated in the packservicio package. 
...
public class ObjectFactory {
    ...
    private final static QName _Suma_QNAME = new QName("http://packServicio/", "suma");
    private final static QName _SumaResponse_QNAME = new QName("http://packServicio/", "sumaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: packservicio
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://packServicio/", name = "suma")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://packServicio/", name = "sumaResponse")
