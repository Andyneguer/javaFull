 ...
 * 
 */
@WebServiceClient(name = "ServicioWeb", targetNamespace = "http://Servicio/", wsdlLocation = "http://localhost:8080/ServicioCRUD/ServicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://Servicio/", "ServicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioCRUD/ServicioWeb?wsdl");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://Servicio/", "ServicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Servicio/", "ServicioWebPort"), ServicioWeb.class, features);
    }
